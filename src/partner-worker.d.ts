/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env-interface=PartnerWorkerBindings src/partner-worker.d.ts` (hash: 8734df2d6a73d2ab2c116c7a4f49e34b)
// Runtime types generated with workerd@1.20260804.1 2026-08-12
interface __BaseEnv_PartnerWorkerBindings {
	PARTNER_APPLICATIONS_DB: D1Database;
	PARTNER_EMAIL: SendEmail;
	PARTNER_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	PARTNER_INTAKE_ENABLED: string;
	PARTNER_INTAKE_LOCAL_ONLY: string;
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_PartnerWorkerBindings {}
}
interface PartnerWorkerBindings extends __BaseEnv_PartnerWorkerBindings {}
