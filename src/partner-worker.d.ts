/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --strict-vars=false --env-interface=PartnerWorkerBindings src/partner-worker.d.ts` (hash: d81bc05639b73d010ecc47869d249255)
